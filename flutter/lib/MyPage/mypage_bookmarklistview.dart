...
class _BookMarkListPageState extends State<BookMarkListPage>
  ...
  final List<String> lr_bookmarkList = <String>[
    "lr_word",
    "Bm",
    'C',
    'D',
  ...
  final List<String> sp_bookmarkList = <String>[
    "sp_word",
    "Bm",
    'C',
    'D',
  ...
  Future<void> speakingBookmarkInfo() async {
    ...
    var response = await http.get(url, headers: {
      ...
      "X-AUTH-TOKEN":
          "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJtaW5wZWFybEBuYXZlci5jb20iLCJpYXQiOjE2NDU0OTY5NDEsImV4cCI6MTY0NTQ5ODc0MX0.g5kqasAyvzWZ_ZkENa6UaXf6_qyiYarmu6xn12CbW7U"
    });
